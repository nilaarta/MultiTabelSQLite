...
import com.example.sqlite_project.Features.CourseCRUD.CreateCourse.SubjectCreateDialogFragment;
import com.example.sqlite_project.Features.CourseCRUD.CreateCourse.SubjectCreateListener;
...
public class SubjectListActivity extends AppCompatActivity implements SubjectCreateListener {
    ...
    private DatabaseDAO databaseQueryClass = new DatabaseDAO(this);
    ...
    private void openSubjectCreateDialog() {
        ...
        subjectCreateDialogFragment.show(getSupportFragmentManager(), Config.CREATE_COURSE);
    }
